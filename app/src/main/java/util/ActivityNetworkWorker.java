...
public abstract class ActivityNetworkWorker extends AsyncTask<Void, Void, Void> {
    ...
    protected void setTargetActivity(Activity activity) {
        targetActivity = new WeakReference<>(activity);
    }

    protected abstract void handleOutput(String serverOutput);

    protected abstract void showInternalError(final String message, final Activity reference);
    ...
    protected Void doInBackground(Void... voids) {
        final Activity reference = targetActivity.get();
